        ...
        <c:if test="${not empty sessionScope.USER}">
            <c:if test="${sessionScope.ADMIN}">
                ...
                <form id="updateForm" 
                            ...
                            <select id="category" class="form-control" name="category">
                                <c:forEach var="dto" items="${sessionScope.CATEGORIES}">
                                    <option value="${dto.categoryName}"
                                            <c:if test="${dto.categoryName eq param.txtCategory}">
                                                selected
                                            </c:if>
                                            >
                                        ${dto.categoryName}
                    ...
                    <div class="form-group row pl-3 pr-3">
                        <label for="datePicker" class="col-sm-2 col-form-label" style="font-size: 1rem;">Import Date</label>
                        <div class="col-sm-10" style="padding-right: 60%">
                          <input 
                              type="text" 
                              class="form-control" 
                    ...
                    <div class="form-group row pl-3 pr-3">
                        ...
                        <div class="col-sm-10" style="padding-right: 60%">
                          <img src="${param.txtPhoto}" width="100px" height="100px" id="ImgSelected" />
                        </div>
                    </div>
                    <div class="form-group row pl-3 pr-3">
                        <div class="custom-file" style="margin-right: 60%; margin-left: 17.5%;">
                            <input type="file" class="custom-file-input" id="imageSource">
                            <input type="hidden" name="photo" value="${param.txtPhoto}" id ="hiddenSource" />
                            <label class="custom-file-label" for="imageSource">Choose file...</label>
                        </div>
                    </div>
                    <div class="pl-3" style="margin-left: 250px;">
                        <input 
                            class="btn shadow-sm" 
