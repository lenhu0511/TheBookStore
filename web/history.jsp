    ...
    <body>
        ...
        <c:if test="${not empty sessionScope.USER}">
            <c:if test="${!sessionScope.ADMIN}">
                ...
                <br/>
                <div class="pl-3">
                    <form action="ServletDispatcher" class="form-inline">
                    ...
                    <form action="ServletDispatcher" class="form-outline">
                            ...
                            <tbody>
                                <c:forEach var="dto" items="${items}" varStatus="counter">
                                    ...
                                    <c:if test="${not empty tmpOrder}">
                                        <c:if test="${tmpOrder.id ne dto.id}">
                                            <tr style="background-color: #FFF4E7;">
                                                <td></td>
                                                <td>${tmpOrder.orderDay}</td>
                                                <td colspan="5"><strong>TOTAL ORDER ${tmpOrder.id}</strong></td>
                ...
                <c:if test="${empty items}">
                    <div class="pl-3" style="font-size: 1.3rem; font-style: italic; color: red;">
                        No record !
                    </div>
                    <br/>
                </c:if>
