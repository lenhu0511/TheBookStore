    ...
    <body>
        ...
        <c:if test="${not empty sessionScope.USER}">
            <c:if test="${sessionScope.ADMIN}">
                ...
                <br/><br/><br/><br/>
                <div class="pl-3" style="font-size: 1.5rem; font-weight: bold; text-align: center;">
                    Create new discount
                </div>
                <form action="ServletDispatcher" id="createForm">
                    <div class="pl-3">
                        <br/>
                        ...
                        Discount value: <input class="form-control mr-sm-2 shadow-sm" 
                                               style="width: 30%; margin-left: 520px;"
                                               type="text" 
                        ...
                        <div class="pl-3" style="text-align: center;">
                    <br/>
