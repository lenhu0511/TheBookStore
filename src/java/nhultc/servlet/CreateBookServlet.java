        ...
        try {
            ...
            if (session.getAttribute("USER") != null) {
                ...
                if (isAdmin) {
                    ...
                    boolean result = bDao.createBook(title, price, author, categoryId, photo, quantity, description);
            ...
            log("CreateBookServlet_NamingException " + ex.getMessage());
        } catch (SQLException ex) {
            log("CreateBookServlet_SQLException " + ex.getMessage());
        } finally {
