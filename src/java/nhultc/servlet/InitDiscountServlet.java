 ...
 * @author Dell
 */
public class InitDiscountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("InitDiscountServlet_NamingException " + ex.getMessage());
        } catch (SQLException ex) {
            log("InitDiscountServlet_SQLException " + ex.getMessage());
        } finally {
