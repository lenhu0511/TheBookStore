...
import nhultc.tbl_order.Tbl_OrderDAO;
import nhultc.tbl_order.Tbl_OrderDTO;
...
public class InitHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Tbl_OrderDTO> result = oDao.getList();
            request.setAttribute("LENGTH", result.size());
            request.setAttribute("RESULT", result);
        } catch (SQLException ex) {
            log("InitHistoryServlet_SQLException " + ex.getMessage());
        } catch (NamingException ex) {
            log("InitHistoryServlet_NamingException " + ex.getMessage());
        } finally {
