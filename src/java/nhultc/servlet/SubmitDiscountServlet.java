...
import nhultc.tbl_discount.Tbl_DiscountDAO;

/**
 *
 * @author Dell
 */
public class SubmitDiscountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("SubmitDiscountServlet_NamingException " + ex.getMessage());
        } catch (SQLException ex ) {
            log("SubmitDiscountServlet_SQLException " +ex.getMessage());
        } finally {
