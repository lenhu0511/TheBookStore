...
import nhultc.tbl_book.Tbl_BookDTO;
import nhultc.tbl_category.Tbl_CategoryDAO;
import nhultc.tbl_category.Tbl_CategoryDTO;

/**
 *
 * @author Dell
 */
public class InitSearchPageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("InitSearchPageServlet_NamingException " + ex.getMessage());
        } catch (SQLException ex) {
            log("InitSearchPageServlet_SQLException " + ex.getMessage());
        } finally {
