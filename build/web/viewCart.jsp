            ...
            <c:if test="${!sessionScope.ADMIN}">
                ...
                <c:if test="${not empty cart}">
                    ...
                    <c:if test="${not empty items}">
                        ...
                        <div class="pl-3 pr-3">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <form action="ServletDispatcher" id="cartForm">
                                        <tr>
                                            <td scope="row">
                                                ${counter.count}
                                            </td>
                                            ...
                                            <td>
                                                <c:url var="removeLink" value="ServletDispatcher">
                                ...
                                <form action="ServletDispatcher">
                                    ...
                                    <td>
                                        <div id="paypalbtn" style="width: 20px;"></div>
                                        <input 
                                            class="btn shadow-sm" 
                                            style="background-color: #FF8C00; color: #F0F8FF;" 
                                    ...
                                    <td>
                                        <a href="InitSearchPageServlet">Add More</a>
                                    </td>
                                </form>
                                </tr>
                                </tbody>
                        ...
                        <div class="pl-3">
                            <a href="InitSearchPageServlet" style="font-size: 1rem;">Back to Search Page</a>
                        </div>
                    </c:if>
                </c:if>
                <c:if test="${empty cart}">
                    <br/>
                    <div class="pl-3" style="font-size: 1.3rem; color: red;">
                        <p style="font-style: italic;">No books exist in the cart</p> <br/>
                        <a href="InitSearchPageServlet" style="font-size: 1rem;">Back to Search Page</a>
                    </div>
                </c:if>
            </c:if>
...
<script src="https://www.paypal.com/sdk/js?client-id=AXIXNfGcmjtK06HspA6RokfoSV_gmKcHxl9GSmZlWamcR-v1jmNa0CE_9yPmhRpNVYDskugsZtbVn0ib&disable-funding=credit,card" ></script>
